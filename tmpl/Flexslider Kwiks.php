...
');
$document->addScript($url . 'modules/mod_tz_multi_slideshow/js/jquery.flexslider-min.js');
$document->addScript($url . 'modules/mod_tz_multi_slideshow/js/css3-mediaqueries.js');
$document->addScript($url . 'modules/mod_tz_multi_slideshow/js/kwiks.js');
?>
