var zoomSliderOptions =
{
    ...
    thumbnailsWrapperId: "mycarousel",
    thumbEffect: 0.5,
    license: "mylicense"
};
...
function ZoomSlider(n) {
    ...
    function kb() {
        ...
        if ((a = c.indexOf("MSIE ")) != -1)b = parseInt(c.substring(a + 5, c.indexOf(".", a))); else if ((a = c.indexOf("Chrome")) != -1)b = 50; else if ((a = c.indexOf("Safari")) != -1)b = 40; else if ((a = c.indexOf("Opera")) != -1)b = 8; else b = 50;
        return b
    }
    ...
    f.a = function () {
        ...
        while (a--) {
            if (f[a] && f[a].i) {
                if (B)window.cancelAnimationFrame(f[a].i); else clearInterval(f[a].i);
                f[a].i = null
            }
            f[a] = null
        }
    ...
    function d(b) {
        ...
        var a = this;
        this.c = function () {
            if (B)a.i = window.requestAnimationFrame(a.c);
            a.l()
        };
        this.d = [];
        this.e = 0;
    ...
    d.prototype = {b: function (a) {
        ...
        if (!this.i)if (B)this.c(); else this.i = window.setInterval(this.c, this.a.b)
    }, j: function (a) {
        this.d[this.d[e]] = a;
        return this
    }, k: function () {
        for (var b = this.a.e(this.f), a = 0; a < this.d[e]; a++)if (this.d[a].B)this.d[a].B(b); else this.d[a](b)
    }, l: function () {
        var b = (new Date).getTime(), c = b - this.g;
        this.g = b;
        var a = c / this.a.c * (this.f < this.e ? 1 : -1);
        if (Math.abs(a) >= Math.abs(this.f - this.e))this.f = this.e; else this.f += a;
        try {
            this.k()
        } finally {
        ...
        if (this.i) {
            if (B)window.cancelAnimationFrame(this.i); else window.clearInterval(this.i);
            this.i = null;
            this.a.d.call(this)
        }
    }, n: function () {
    ...
    function V(c, b, d, e, a) {
        this.el = c;
        if (b == "opacity" && I < 9 && window.ActiveXObject)this.w = "filter"; else this.w = b;
        this.x = parseFloat(d);
        this.y = parseFloat(e);
    ...
    V.prototype = {B: function (e) {
        if (this.w == "ie" || this.w == "mb") {
            ...
            if (C == l || l < O) {
                ...
                if (l == Math.round(C))return;
                l = Math.round(C);
                if (this.w == "ie")this.el[a][r] = l + "px"; else this.el.getContext("2d").drawImage(b.c[b.a], R ? k - l : 0, 0, l, Math.round(l * v / k));
                return
            }
        }
        var d = this.C(e);
        if (this.el[a][this.w] != d)this.el[a][this.w] = d
    }, C: function (a) {
    ...
    function ab(g, m, n) {
        ...
        for (a in c) {
            ...
            f = this.F.exec(h);
            var d = this.F.exec(j);
            if (f[1] != null)b = f[1]; else if (d[1] != null)b = d[1]; else b = d;
    ...
    ab.prototype = {D: function (f) {
        ...
        for (var a = 0; a < this.d[e]; a++)this.d[a].B(b)
    ...
    var l = -1, C = -1, R = 0, K = 1, U = 1, c, o, p, w, j, m, Q, G, J, D, F, y, db, u, q, k, O, v, M, eb, s, W, i = null, X = function () {
        c = {b: n.slideInterval, O0: n.license, c: n.autoAdvance, d: n.captionEffect == "none" ? 0 : n.captionEffect == "fade" ? 1 : 2, f: n.captionOpacity, g: n.thumbnailsWrapperId, e: n.thumbEffect, v: "mycarousel", Ob: function () {
    ...
    function ib() {
        var d;
        if (c.g)d = S(c.g);
        if (d)g = d.getElementsByTagName("img");
        if (g && c.e) {
            if (T)return;
            T = 1;
            var a = g[e];
            while (a--) {
                ...
                if (!g[a].onclick)g[a].onclick = function () {
                    i.t(this.i)
                }
            }
            Z(0)
    ...
    function Z(b) {
        if (g && c.e) {
            var a = g[e];
            while (a--)gb(g[a], a == b ? 1 : -1)
        }
    }

    function gb(a, b) {
        if (c.e == 1)cb(a, b); else if (b == 1 && a.o < 1) {
            x(a, a.o + .05);
            setTimeout(function () {
                gb(a, 1)
            }, 20)
        } else b == -1 && a.o != c.e && x(a, c.e)
    }

    function bb(b, a) {
        if (c.e == 1)cb(b, a); else x(b, a == 1 ? 1 : c.e)
    }

    function cb(d, h) {
        if (I < 9)d[a].filter = "progid:DXImageTransform.Microsoft.BasicImage(grayScale=" + (h == -1 ? 1 : 0) + ")"; else if (h == -1) {
    ...
    hb.prototype = {c: function (a) {
        if (q[a].nodeName == "IMG")var b = q[a]; else b = q[a].getElementsByTagName("img")[0];
        return b
    }, d: function (d) {
        d[a][z] = "block";
        k = d[L];
        ...
        this.i();
        var d = this.q();
        if (b.e)y = setTimeout(function () {
            d.m(0)
        }, 4)
    }, g: function () {
        u = A("div");
        u[h] = "navBulletsWrapper";
        for (var d = [], a = 0; a < b.e; a++)d.push("<div rel='" + a + "'></div>");
        u[H] = d.join("");
        for (var c = P(u), a = 0; a < c[e]; a++) {
            if (a == b.a)c[a][h] = "active";
            c[a].onclick = function () {
                if (this[h] == "active")return 0;
                clearTimeout(y);
                y = null;
                f.a();
        ...
        var c = P(u), a = c[e];
        while (a--)if (a == b.a)c[a][h] = "active"; else c[a][h] = ""
    }, jiaMi: function (a, d) {
        var c = function (b) {
        ...
        e[a].zIndex = 2;
        b.a++;
        if (b.a == b.e)b.a = 0; else if (b.a < 0)b.a = b.e - 1;
        b.b = b.d[b.a];
        clearTimeout(db);
        db = null;
        var g = this.k();
        ...
        var f = {c: c.v == -1 ? 20 : g == 9 ? 100 : 900, e: d.tx.u, d: function () {
            ...
            Z(b.a);
            var c = b.e;
            while (c--)if (c != b.a)b.d[c][a][z] = "none"
        }};
        ...
        var f = {c: c.b, e: d.tx.t, b: 20, d: function () {
            if (U && K == 1 && k - b[L] > W)s += .5;
            c.c && i.m(0)
        }};
        if (s == 0 || e < 1)a[0] = a[1] = "opacity:1";
        d.p(b, a[0], a[1], f)
    }, q: function () {
        ...
        var a;
        if (b.a == 0 && c == -1)a = b.e - 1; else if (b.a == b.e - 1 && c == 1)a = 0; else a = b.a + c;
        this.t(a)
    }};
    var Y = function () {
        var a = S(n.sliderId);
