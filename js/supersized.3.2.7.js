...
(function($){
    ...
    $.supersized = function(options, show_music,urlpath){

        var background_sound = new buzz.sound(urlpath,{
        ...
        $('span.music_icon').click(function(){
            background_sound.pause();
            $(this).hide();
            $('span.close-music').css('display','inline-block');
        });
        $('span.close-music').click(function(){
            background_sound.play();
            $(this).hide();
            $('span.music_icon').css('display','inline-block');
        });
        /* Variables
         ----------------------------*/
